...
### Backend Developer Jr. | Java · Spring Boot · Node.js

Desarrollo APIs REST y aplicaciones orientadas a resolver problemas reales, con foco en seguridad, reglas de negocio, bases de datos y código mantenible.

🎓 Técnico Universitario en Programación  
📚 Estudiante de la Licenciatura en Informática en la UNAHUR  
...
![Swagger](https://img.shields.io/badge/Swagger-85EA2D?style=flat-square&logo=swagger&logoColor=111827)
...
- Profundizando en arquitectura backend, seguridad y testing.
- Mejorando la calidad y el despliegue de mis proyectos.
- Construyendo soluciones con Java, Spring Boot, Node.js y Docker.
- Ampliando mis conocimientos de cloud y automatización.
